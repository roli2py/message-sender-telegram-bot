...
from . import consts, database_tables, fstrings
...
class Handlers:
    ...
    async def start(
        ...
        if user is None:
            await chat.send_message(consts.Answers.UNKNOWN_ERROR_OCCURED)
            return
    ...
    async def generate_token(
        ...
        await user.send_message(
            fstrings.Answers.new_token.format(token=hex_token.get()),
